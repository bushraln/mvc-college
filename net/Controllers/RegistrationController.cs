...
namespace net.Controllers
{
    public class RegistrationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,firstname,lastname,nic,course_id,batch_id,phone")] registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,firstname,lastname,nic,course_id,batch_id,phone")] registration registration)
        {
            if (ModelState.IsValid)
            {
